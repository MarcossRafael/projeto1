...
page = requests.get('https://www.sofascore.com/pt/football/match/nova-iguacu-flamengo/GucsGOc#id:13198181')

url = "https://www.sofascore.com/api/v1/event/13198181/statistics"
...
if response.status_code == 200:
    ...
    # Exporta para Excel
    excel_file = 'iguaçuxfla_stats.xlsx'
