...
page = requests.get('https://www.sofascore.com/pt/football/match/flamengo-bangu-atletico-clube/TOsGuc#id:13198186')

url = "https://www.sofascore.com/api/v1/event/13198186/statistics"
...
if response.status_code == 200:
    ...
    # Exporta para Excel
    excel_file = 'banguxfla_stats.xlsx'
